...
"[project]/hooks/useContracts.ts [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/store/contractStore.ts [app-client] (ecmascript) <export useContractStore as useContracts>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useContracts$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/hooks/useContracts.ts [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$contractStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__useContractStore__as__useContracts$3e$__ = __turbopack_context__.i("[project]/store/contractStore.ts [app-client] (ecmascript) <export useContractStore as useContracts>");
;
...
function TopBar({ onStartClick, onNewClick, onGenerateClick, isGenerating }) {
    _s();
    const { currentContract } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$contractStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__useContractStore__as__useContracts$3e$__["useContracts"])();
    const modeConfig = {
        'trad': {
            label: 'TRADICIONAL',
            className: 'mode-trad'
...
_s(TopBar, "9LQJ0KMp5zbW3q8nSQ4qcySr3i4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$contractStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__useContractStore__as__useContracts$3e$__["useContracts"]
    ];
});
_c = TopBar;
var _c;
...
function Sidebar({ onSettingsClick }) {
    _s();
    const { currentContract, contracts, selectContract } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$contractStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__useContractStore__as__useContracts$3e$__["useContracts"])();
    ...
    const handleGenerate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Home.useCallback[handleGenerate]": async ()=>{
            ...
            if (result?.ok) {
                ...
                if (result.url) {
                    setTimeout({
                        "Home.useCallback[handleGenerate]": ()=>window.open(result.url, '_blank')
                    }["Home.useCallback[handleGenerate]"], 500);
                }
            } else if (!result) {
...
_s(Home, "37N7JVxtGx4pVvmfX1vDYzT6W7U=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useTheme$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTheme"],
        __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$contractStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__useContractStore__as__useContracts$3e$__["useContracts"],
...
//# sourceMappingURL=_6040f726._.js.map