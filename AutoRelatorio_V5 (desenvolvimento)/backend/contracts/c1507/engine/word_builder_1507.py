# contracts/c1507/engine/word_builder_1507.py — Contrato 1507
# Cuiabá — Word Builder Modo Tradicional
...
def inserir_conteudo(
    ...
    """
    Gera o .docx do contrato 1507 (Cuiabá) a partir do conteudo[].

    Args:
        modelo_path: Caminho para MODELO-1507.docx
        conteudo:    Array conteudo[] produzido pelo scanner_1507
