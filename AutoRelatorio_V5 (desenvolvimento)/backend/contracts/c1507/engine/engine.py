# contracts/c1507/engine/engine.py — Contrato 1507
# Cuiabá — Motor Tradicional
# Migração de generator.py + word_utils.py do V4

from core.contract_engine import ContractEngine, MetaField, ValidationResult
import os

class Contract1507Engine(ContractEngine):
    contract_id     = "1507"
    contract_name   = "Cuiabá"
    template_file   = "MODELO-1507.docx"
    ...
    def get_meta_fields(self) -> list[MetaField]:
        ...
        return [
            ...
            MetaField("ag_cod",                  "Código da Agência",    "text", required=True,  example="1507-0"),
    ...
    def scan(self, root_path: str, logger=None) -> list:
        ...
        import tempfile, os
        log_path = os.path.join(tempfile.gettempdir(), "c1507_scan_errors.txt")
