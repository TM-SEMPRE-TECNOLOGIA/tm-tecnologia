# contracts/c2626/engine/scanner_2626.py — Contrato 2626
# Salinas — Scanner Modo Tradicional
...
def build_content_from_root(
    ...
    """
    Varre a pasta raiz do contrato 2626 (Salinas) e monta conteudo[].
    ...
    with open(log_errors_path, "w", encoding="utf-8") as log:
        log.write("LOG DE ERROS — c2626 Salinas — Leitura de pastas\n\n")

    conteudo: List[Any] = []
    logger(">>> [c2626] Lendo estrutura de pastas...")
    ...
    logger(">>> [c2626] Estrutura lida completamente.")
    return conteudo
