# contracts/c2626/engine/engine.py — Contrato 2626
# Salinas — Motor Tradicional
# Migração de generator.py + word_utils.py do V4

from core.contract_engine import ContractEngine, MetaField, ValidationResult
import os

class Contract2626Engine(ContractEngine):
    contract_id     = "2626"
    contract_name   = "Salinas"
    template_file   = "MODELO-2626.docx"
    ...
    def get_meta_fields(self) -> list[MetaField]:
        ...
        return [
            ...
            MetaField("ag_cod",                  "Código da Agência",    "text", required=True,  example="2626-0"),
    ...
    def scan(self, root_path: str, logger=None) -> list:
        ...
        import tempfile, os
        log_path = os.path.join(tempfile.gettempdir(), "c2626_scan_errors.txt")
