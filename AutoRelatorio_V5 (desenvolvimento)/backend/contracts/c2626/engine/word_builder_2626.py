# contracts/c2626/engine/word_builder_2626.py — Contrato 2626
# Salinas — Word Builder Modo Tradicional
...
def inserir_conteudo(
    ...
    """
    Gera o .docx do contrato 2626 (Salinas) a partir do conteudo[].

    Args:
        modelo_path: Caminho para MODELO-2626.docx
        conteudo:    Array conteudo[] produzido pelo scanner_2626
