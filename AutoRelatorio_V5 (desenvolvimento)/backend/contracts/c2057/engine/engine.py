# contracts/c2057/engine/engine.py — Contrato 2057
# Varginha — Motor Tradicional
# Migração de generator.py + word_utils.py do V4

from core.contract_engine import ContractEngine, MetaField, ValidationResult
import os

class Contract2057Engine(ContractEngine):
    contract_id     = "2057"
    contract_name   = "Varginha"
    template_file   = "MODELO-2057.docx"
    ...
    def get_meta_fields(self) -> list[MetaField]:
        ...
        return [
            ...
            MetaField("ag_cod",                  "Código da Agência",    "text", required=True,  example="2057-0"),
    ...
    def scan(self, root_path: str, logger=None) -> list:
        ...
        import tempfile, os
        log_path = os.path.join(tempfile.gettempdir(), "c2057_scan_errors.txt")
