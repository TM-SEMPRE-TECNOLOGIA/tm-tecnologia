# contracts/c2057/engine/word_builder_2057.py — Contrato 2057
# Varginha — Word Builder Modo Tradicional
...
def inserir_conteudo(
    ...
    """
    Gera o .docx do contrato 2057 (Varginha) a partir do conteudo[].

    Args:
        modelo_path: Caminho para MODELO-2057.docx
        conteudo:    Array conteudo[] produzido pelo scanner_2057
