# contracts/c2057/engine/generator_2057.py — Contrato 2057
# Varginha — Pipeline completo (scan + build)
...
from .scanner_2057 import build_content_from_root
from .word_builder_2057 import inserir_conteudo
...
def run_all(
    ...
    """Pipeline completo do contrato 2057 (Varginha): varre pasta → monta conteudo[] → gera .docx"""
    ...
    log_errors = os.path.join(pasta_saida, "c2057_erros_pastas.txt")
    log_process = os.path.join(pasta_saida, "c2057_process_log.txt")
    ...
    with open(log_process, "w", encoding="utf-8") as f:
        f.write("PROCESS LOG — c2057 Varginha\n\n")
