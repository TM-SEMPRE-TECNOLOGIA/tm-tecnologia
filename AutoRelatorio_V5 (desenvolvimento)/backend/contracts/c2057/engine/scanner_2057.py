# contracts/c2057/engine/scanner_2057.py — Contrato 2057
# Varginha — Scanner Modo Tradicional
...
def build_content_from_root(
    ...
    """
    Varre a pasta raiz do contrato 2057 (Varginha) e monta conteudo[].
    ...
    with open(log_errors_path, "w", encoding="utf-8") as log:
        log.write("LOG DE ERROS — c2057 Varginha — Leitura de pastas\n\n")

    conteudo: List[Any] = []
    logger(">>> [c2057] Lendo estrutura de pastas...")
    ...
    logger(">>> [c2057] Estrutura lida completamente.")
    return conteudo
