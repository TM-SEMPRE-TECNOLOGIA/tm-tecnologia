# contracts/c3575/engine/engine.py — Contrato 3575
# Tangará da Serra — Motor Tradicional
# Migração de generator.py + word_utils.py do V4

from core.contract_engine import ContractEngine, MetaField, ValidationResult
import os

class Contract3575Engine(ContractEngine):
    contract_id     = "3575"
    contract_name   = "Tangará da Serra"
    template_file   = "MODELO-3575.docx"
    ...
    def get_meta_fields(self) -> list[MetaField]:
        ...
        return [
            ...
            MetaField("ag_cod",                  "Código da Agência",    "text", required=True,  example="3575-0"),
    ...
    def scan(self, root_path: str, logger=None) -> list:
        ...
        import tempfile, os
        log_path = os.path.join(tempfile.gettempdir(), "c3575_scan_errors.txt")
