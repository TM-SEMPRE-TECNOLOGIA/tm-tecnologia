# contracts/c3575/engine/generator_3575.py — Contrato 3575
# Tangará da Serra — Pipeline completo (scan + build)
...
from .scanner_3575 import build_content_from_root
from .word_builder_3575 import inserir_conteudo
...
def run_all(
    ...
    """Pipeline completo do contrato 3575 (Tangará da Serra): varre pasta → monta conteudo[] → gera .docx"""
    ...
    log_errors = os.path.join(pasta_saida, "c3575_erros_pastas.txt")
    log_process = os.path.join(pasta_saida, "c3575_process_log.txt")
    ...
    with open(log_process, "w", encoding="utf-8") as f:
        f.write("PROCESS LOG — c3575 Tangará da Serra\n\n")
