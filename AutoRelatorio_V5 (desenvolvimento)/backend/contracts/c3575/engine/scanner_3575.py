# contracts/c3575/engine/scanner_3575.py — Contrato 3575
# Tangará da Serra — Scanner Modo Tradicional
...
def build_content_from_root(
    ...
    """
    Varre a pasta raiz do contrato 3575 (Tangará da Serra) e monta conteudo[].
    ...
    with open(log_errors_path, "w", encoding="utf-8") as log:
        log.write("LOG DE ERROS — c3575 Tangará da Serra — Leitura de pastas\n\n")

    conteudo: List[Any] = []
    logger(">>> [c3575] Lendo estrutura de pastas...")
    ...
    logger(">>> [c3575] Estrutura lida completamente.")
    return conteudo
