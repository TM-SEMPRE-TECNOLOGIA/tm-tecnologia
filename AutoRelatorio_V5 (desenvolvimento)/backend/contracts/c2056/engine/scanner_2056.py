# contracts/c2056/engine/scanner_2056.py — Contrato 2056
# Divinópolis — Scanner Modo Tradicional
...
def build_content_from_root(
    ...
    """
    Varre a pasta raiz do contrato 2056 (Divinópolis) e monta conteudo[].
    ...
    with open(log_errors_path, "w", encoding="utf-8") as log:
        log.write("LOG DE ERROS — c2056 Divinópolis — Leitura de pastas\n\n")

    conteudo: List[Any] = []
    logger(">>> [c2056] Lendo estrutura de pastas...")
    ...
    logger(">>> [c2056] Estrutura lida completamente.")
    return conteudo
