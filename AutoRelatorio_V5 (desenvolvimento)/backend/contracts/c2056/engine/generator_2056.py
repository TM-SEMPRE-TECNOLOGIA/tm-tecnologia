# contracts/c2056/engine/generator_2056.py — Contrato 2056
# Divinópolis — Pipeline completo (scan + build)
...
def run_all(
    ...
    """Pipeline completo do contrato 2056 (Divinópolis): varre pasta → monta conteudo[] → gera .docx"""
    ...
    log_errors = os.path.join(pasta_saida, "c2056_erros_pastas.txt")
    log_process = os.path.join(pasta_saida, "c2056_process_log.txt")
    ...
    with open(log_process, "w", encoding="utf-8") as f:
        f.write("PROCESS LOG — c2056 Divinópolis\n\n")
