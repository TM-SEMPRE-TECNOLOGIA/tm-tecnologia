# contracts/c6122/engine/scanner_6122.py — Contrato 6122
# Mato Grosso do Sul — Scanner Modo Tradicional
...
def build_content_from_root(
    ...
    """
    Varre a pasta raiz do contrato 6122 (Mato Grosso do Sul) e monta conteudo[].
    ...
    with open(log_errors_path, "w", encoding="utf-8") as log:
        log.write("LOG DE ERROS — c6122 Mato Grosso do Sul — Leitura de pastas\n\n")

    conteudo: List[Any] = []
    logger(">>> [c6122] Lendo estrutura de pastas...")
    ...
    logger(">>> [c6122] Estrutura lida completamente.")
    return conteudo
