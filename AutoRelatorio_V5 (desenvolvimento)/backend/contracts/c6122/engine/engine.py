# contracts/c6122/engine/engine.py — Contrato 6122
# Mato Grosso do Sul — Motor Tradicional
# Migração de generator.py + word_utils.py do V4

from core.contract_engine import ContractEngine, MetaField, ValidationResult
import os

class Contract6122Engine(ContractEngine):
    contract_id     = "6122"
    contract_name   = "Mato Grosso do Sul"
    template_file   = "MODELO-6122.docx"
    ...
    def get_meta_fields(self) -> list[MetaField]:
        ...
        return [
            ...
            MetaField("ag_cod",                  "Código da Agência",    "text", required=True,  example="6122-0"),
    ...
    def scan(self, root_path: str, logger=None) -> list:
        ...
        import tempfile, os
        log_path = os.path.join(tempfile.gettempdir(), "c6122_scan_errors.txt")
